...
namespace FitnessWebApp.Controllers
{
    ...
    public class TrainingPlanController : Controller
    {
        ...
        public TrainingPlanController(AppDbContext context, UserManager<User> userManager, IConfiguration configuration, JWTservice jwtService, ITrainingPlanManager trainingPlanManager)
        {
        ...
        public async Task<ActionResult<ICollection<TrainingPlan>>> GetAllPlans()
        {
            ...
            return await _trainingPlanManager.GetAllPlans();
        }
